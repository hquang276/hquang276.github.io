    ...
    if (isset($_SESSION['orderDetails']) && !empty($_SESSION['orderDetails'])) {
        ...
        <input type="hidden" name="id" value="">
          <span><h1>' . $item['quantity'] . '</h1> </span>
            ...
            <button type="submit" name="btnclear_cart" class="clear-cart-button">Xóa Đơn</button>
          
            </form>
            <form method="post" action="">
            <button type="submit" name="buy" class="buy-button">Duyệt Đơn</button>
        ...
        echo '<a href="../main/admin_page.php" style="text-decoration : none ;"><h1 style ="color : red ; text-align : center ; padding :5%">Chưa Có Đơn Hàng Nào </h1></a>';
    }
